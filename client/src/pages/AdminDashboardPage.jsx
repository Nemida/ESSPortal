  ...
  return (
    <div className="max-w-7xl mx-auto py-6 sm:py-12 px-4 sm:px-6 lg:px-8 font-sans">
      <div className="bg-white p-4 sm:p-8 rounded-lg shadow-lg">
        <h1 className="text-2xl sm:text-3xl font-bold text-[#2c3e50] border-b pb-4">Admin Dashboard</h1>
        
        <section className="mt-6 sm:mt-8 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6">
        ...
        <section className="mt-8 sm:mt-12 border-t pt-6 sm:pt-8">
          <h2 className="text-xl sm:text-2xl font-bold text-[#2c3e50] mb-4">Manage Key Moments Images</h2>
          <form onSubmit={handleAddImage} className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 mb-6 bg-gray-50 p-4 rounded-lg border">
        ...
        <section className="mt-8 sm:mt-12 border-t pt-6 sm:pt-8">
          <h2 className="text-xl sm:text-2xl font-bold text-[#2c3e50] mb-4">Manage Homepage Announcements</h2>
          <form onSubmit={handleAddAnnouncement} className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6 bg-gray-50 p-4 rounded-lg border">
