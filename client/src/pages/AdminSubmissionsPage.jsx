...
const AdminSubmissionsPage = () => {
  ...
  useAutoRefresh('submissions', fetchSubmissions);

  return (
    <div className="max-w-7xl mx-auto py-6 sm:py-12 px-4 sm:px-6 lg:px-8 font-sans">
      <div className="bg-white p-4 sm:p-8 rounded-lg shadow-lg">
        <h1 className="text-2xl sm:text-3xl font-bold text-[#2c3e50] border-b pb-4">Form Submissions Inbox</h1>
        <p className="mt-4 text-sm sm:text-base text-gray-600">Review all forms submitted by employees.</p>
        ...
        <div className="mt-6 sm:mt-8 space-y-4 sm:space-y-6">
          {loading ? (
            ...
            submissions.map(sub => (
              <div key={sub.submission_id} className="p-4 sm:p-5 border rounded-lg bg-gray-50 shadow-sm">
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2 mb-3">
                  <h2 className="text-lg sm:text-xl font-bold text-gray-800">{sub.form_title}</h2>
